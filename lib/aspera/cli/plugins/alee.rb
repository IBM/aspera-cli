  ...
  module Cli
    module Plugins
      class Alee < BasicAuth
        command :health, description: 'Check health of ALEE metering server', handler: lambda {
          nagios = Nagios.new
          begin
        ...
        command :entitlement, description: 'Show entitlement information', handler: lambda {
