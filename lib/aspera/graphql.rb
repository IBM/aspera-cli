...
module Aspera
  # Helper to execute GraphQL queries via a Rest::Client object.
  ...
  module GraphQL
    ...
    class << self
      ...
      # @param rest      [Rest::Client]   API object pointing at the GraphQL endpoint
