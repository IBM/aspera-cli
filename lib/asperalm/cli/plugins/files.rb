    ...
    module Plugins
      class Files < Plugin
        ...
        def declare_options
          ...
          Main.tool.options.add_opt_simple(:url,"URI","URL of application, e.g. http://org.asperafiles.com")
          ...
          Main.tool.options.add_opt_simple(:private_key,"STRING","RSA private key PEM value for JWT (prefix file path with @val:@file:)")
