...
rubyinstaller-devkit-3.3.8-1-x64.exe /silent /currentuser /noicons /dir=%TARGET_FOLDER%
...
CALL %TARGET_FOLDER%\bin\ascli conf ascp install --sdk-url=file:///ibm-aspera-transfer-sdk-windows-amd64-1.1.5.zip
